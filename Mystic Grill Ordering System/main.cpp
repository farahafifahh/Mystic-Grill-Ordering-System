...
void menuList(string menu[], double price[], int list)
{
    ...
    // Open the file
    inFile.open("/Users/farahafifah/Mystic Grill Ordering System/Mystic Grill Ordering System/Menu.txt");
...
void selectMenu(string menuList[], string name, int order, double price[], double subtotal1)
{
    ...
    // Open the outputfile
    outFile.open("/Users/farahafifah/Mystic Grill Ordering System/Mystic Grill Ordering System/CustomerOrder.txt");
